...
namespace TownOfUs.NeutralRoles.ForetellerMod
{
    public class DoomsayerKill
    {
        ...
        {
            var doom = Role.GetRole<Foreteller>(doomsayer);
            doom.CorrectAssassinKills += 1;
            if(doom.CorrectAssassinKills >= 4)
                doom.WonByGuessing = true;
            //MurderPlayer(doom.Player, true);
            //if (!CustomGameOptions.NeutralEvilWinEndsGame) MurderPlayer(doom.Player, true);
        }
        //public static void DoomKillCount(PlayerControl player, PlayerControl doomsayer)
        //{
        //    var doom = Role.GetRole<Doomsayer>(doomsayer);
        //    if (player == doomsayer) doom.IncorrectAssassinKills += 1;
        //    else doom.CorrectAssassinKills += 1;
        //    //doom.CorrectAssassinKills += 1;
        //    //doom.WonByGuessing = true;
