...
namespace TownOfUs.Roles
{
    public class Arsonist : Role
    {
        ...
        {
            Name = "Arsonist";
            ImpostorText = () => Patches.TranslationPatches.CurrentLanguage == 0 ? "Douse Players And Ignite The Light" : "Oblej Graczy I Podpal Ich";
            TaskText = () => Patches.TranslationPatches.CurrentLanguage == 0 ? "Douse players and ignite to kill all douses\nFake Tasks:" : "Oblej graczy i podpal by zabic wszystkich oblanych\nFake Tasks:";
