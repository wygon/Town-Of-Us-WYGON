...
namespace TownOfUs.Roles
{
    public class Snitch : Role
    {
        ...
        {
            Name = "Snitch";
            ImpostorText = () => Patches.TranslationPatches.CurrentLanguage == 0 ? "Complete All Your Tasks To Discover The Impostors" : "Skoncz Wszystkie Taski i Odkryj Impostorow";
